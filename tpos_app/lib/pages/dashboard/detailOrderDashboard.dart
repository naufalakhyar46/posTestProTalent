...
class DetailOrderDashboardPage extends StatefulWidget{
  final Order? order;

  DetailOrderDashboardPage({
    this.order,
  });

  @override
  _DetailOrderDashboardState createState() => _DetailOrderDashboardState();
}

class _DetailOrderDashboardState extends State<DetailOrderDashboardPage> {
  bool loading = false;
  Order? order_data;
